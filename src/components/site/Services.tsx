import {
  ...
  UserPlus, Compass, CreditCard, ArrowUpRight, CheckCircle2,
} from "lucide-react";
    ...
    <section id="services" ref={ref} className="py-20 md:py-28 relative overflow-hidden">
      ...
      <div className="container">
          ...
          {featuredServices.map((s, i) => {
            ...
            return (
              ...
              >
                ...
                <p className="mt-4 text-xs font-semibold uppercase tracking-wide text-primary">Request service</p>
        ...
        <div className="mt-8 reveal rounded-2xl border border-border bg-card p-6 md:p-7 shadow-soft">
          <p className="text-xs font-semibold uppercase tracking-wide text-primary">Also available</p>
